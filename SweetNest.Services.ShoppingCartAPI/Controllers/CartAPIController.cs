...
namespace SweetNest.Services.ShoppingCartAPI.Controllers
{
    [Route("api/cart")]
    [ApiController]
    public class CartAPIController : ControllerBase
    {
        ...
        [HttpPost("ClearCart")]
        public async Task<ResponseDto> ClearCart([FromBody] int cartHeaderId)
        {
            try
            {
                ...
                var cartHeader = await _db.CartHeaders.FirstOrDefaultAsync(u => u.CartHeaderId == cartHeaderId);
                if (cartHeader != null)
                {
